...
let geburtsdatumInput = document.getElementsByName('birthdayInput')[0];
function saveBirthday() {
    let geburtsdatum: Date | string;
    geburtsdatum = (geburtsdatumInput as HTMLInputElement).value
...
//// sollte die Datumvariable von String zu Date umgewandelt werden, dann mit dem Uniontype Date | string lässt sich die Umwandlung mit der gleichen Variable erledigen.
